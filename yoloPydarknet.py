...
class pydarknetYOLO():
    ...
    def drawPred(self, frame, label, conf, bold, boldcolor, textcolor, textsize, left, top, right, bottom):
        ...
        #cv2.putText(frame, label, (left, top), cv2.FONT_HERSHEY_SIMPLEX, 1.6, textcolor, 3)
        #cv2.putText(frame, score, (left+30, top), cv2.FONT_HERSHEY_SIMPLEX, 0.86, (0,0,0), 2)
